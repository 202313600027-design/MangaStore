...
function form($action,$var1,$var2,$var3,$var4,$var5,$var6,$var7,$b1,$b2,$b3,$b4){
                echo "
                <style type='text/css'>
                label.incluir {
               ...
               if(isset($var1)){
                ...
                if(isset($var2)){
                               ...
                               echo "<input type='email' name='$var2'/><br/>";
               }
                if(isset($var3)){
                               echo "<label for= $var3 class='incluir'>$var3:</label>";
                               echo "<input type='date' name='$var3'/><br/>";
               }
                if(isset($var4)){
         ...
         if(isset($b4)) echo"<input type='submit' value='$b4' name='$b4'/>";
